...
function StatefulTextLine(
  props: InputTypeComponentProps<TextLineConfig> & { initialValue?: Value },
) {
...
export const WithRtlLocale: Story = {
  ...
  render: () => (
    <LocaleProvider locale="ar-SA">
      <div className="flex flex-col gap-y-3 p-4">
        <div className="max-w-120 text-sm text-subtle">
          Wrapped in <code>LocaleProvider locale="ar-SA"</code>. The input is rendered right-to-left
...
function WithRegistryDemo() {
  ...
  return (
    <FieldRegistryProvider registry={registry}>
      <div className="flex flex-col gap-y-3 p-4">
        <div className="max-w-120 text-sm text-subtle">
          Acquire a processing lock via the registry. The field becomes read-only and shows a
