import { pad } from '@enonic/ui-utils';
...
import {
  formatTimezoneLabel,
  instantDisplayToValue as displayToValue,
  instantStorageToDisplay as storageToDisplay,
  instantValueToDisplay as valueToDisplay,
} from './instant-input';
...
describe('InstantInput', () => {
  ...
  describe('displayToValue', () => {
    ...
    it.each(['2025-06-15 14:30:45', '2025-06-15 14:30:45.123'])(
      'rejects input carrying seconds "%s"',
      (input) => {
