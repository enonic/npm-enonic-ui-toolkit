    ...
    <div className="flex flex-col gap-y-4">
      {showHelp && (
        <p className="w-80 rounded-md border border-bdr-subtle bg-surface-neutral px-3 py-2 text-sm leading-5">
          Press Tab to enter the list, use ArrowUp and ArrowDown to move between rows, and use
          ArrowLeft and ArrowRight to move between row actions before picking an item up. Once Space
          picks the row up, dnd-kit keyboard reordering owns the arrows until Space drops it again.
        </p>
      )}
      <div className="w-80">
        <SortableGridList
  ...
  return (
    <div className="flex w-80 flex-col gap-y-3">
      <p className="rounded-md border border-bdr-subtle bg-surface-neutral px-3 py-2 text-sm leading-5">
        Press Tab to enter the list, use ArrowUp and ArrowDown to move between rows, then press
        Space to pick up the focused item. Once picked up, dnd-kit keyboard reordering takes over
        until Space drops it again.
      </p>
      <SortableGridList
        items={items}
        keyExtractor={keyExtractor}
