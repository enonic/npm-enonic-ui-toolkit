...
function makeInput(): SchemaInput {
    ...
    <div className="w-100 space-y-6 p-4">
      <div className="space-y-2 text-sm">
        ...
        <p className="text-subtle">
          The step matches the most decimal places the user has typed. Once set to a finer
          precision, it stays there — it only resets to a coarser step when the user types a
          different precision value, or when the value is reset externally (e.g. a form reset).
        </p>
